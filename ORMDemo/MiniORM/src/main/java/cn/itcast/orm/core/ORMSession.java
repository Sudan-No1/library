...
public class ORMSession {
    ...
    public void save(Object entity) throws Exception {
        ...
        Map<String,Mapper> mapperMap = ORMConfig.mapperMap;

        //2. 遍历集合，从集合中找到和entity参数相对应的mapper对象
        Mapper mapper = mapperMap.get(entity.getClass().getName());
        if(mapper == null){
            return;
        }
        ...
        for (Field field : fields) {
            ...
            //4. 遍历过程中根据属性得到字段名
            String columnName = propMapper.get(field.getName());
            //5. 遍历过程中根据属性得到它的值
    ...
    public Object findOne(Class clz, Object id) throws  Exception{
        ...
        Map<String,Mapper> mapperMap = ORMConfig.mapperMap;
        Mapper mapper = mapperMap.get(clz.getName());
        // 3. 获得表名
        String tableName = mapper.getTableName();
